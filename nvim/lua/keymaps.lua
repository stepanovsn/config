...
vim.keymap.set('n', '<F4>', function() vim.cmd.quit() end)
...
vim.keymap.set('n', '<Leader>isr', 'a\\reference[text=""]{}<ESC>i')
...
vim.keymap.set('n', '<Leader>ise', 'o\\listing[wrap numbered syntax="cpp"]<Enter>\\end<ESC>O')
...
vim.keymap.set('n', '<Leader>ie', 'o\\thead<Enter> \\cell  \\cell  \\end<Enter><Left>\\tbody[full headcol=1 fixed width5=100]<ESC>$<Delete><Up>0i')
vim.keymap.set('n', '<Leader>ia', 'o\\annotation<Enter> \\split  \\end<ESC>0i')
vim.keymap.set('n', '<Leader>ic', 'o\\complex[type=log]<Enter>\\entry[type=track]<Enter>\\entry[type=event position=0]<Enter>')
